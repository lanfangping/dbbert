        ...
        if os.path.isdir(subfolder_path):
            ...
            for file in os.listdir(subfolder_path):
                ...
                if os.path.isfile(file_path):
                    ...
                    passages, passage_idx_entities_relations_mapping = get_entities_and_relations(lines)
                    print("+++++++++++++++++++++")
                    print(passage_idx_entities_relations_mapping)
                    print("+++++++++++++++++++++")
                    # print(sent_relations)
                    if len(passage_idx_entities_relations_mapping) != 0:
                        store_passages_entities_relation(doc_id, passages, passage_idx_entities_relations_mapping)
